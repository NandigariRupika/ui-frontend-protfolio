...
- About section with profile image and quick facts  
- Skills section using responsive card layout  
- Interactive image gallery with hover zoom effect  
...
- **JavaScript** – Basic scripting and enhancements  
